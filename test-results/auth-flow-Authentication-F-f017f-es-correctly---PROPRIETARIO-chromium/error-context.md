...
- Name: Authentication Flow E2E >> should handle different user profiles correctly - PROPRIETARIO
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:131:3
...
Call log:
  - waiting for locator('input[placeholder="seu@email.com"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:134:16
```
