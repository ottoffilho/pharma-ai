...
- Name: Authentication Flow E2E >> should handle login error for invalid credentials
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:51:3
...
Call log:
  - waiting for locator('input[placeholder="seu@email.com"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:55:16
```
