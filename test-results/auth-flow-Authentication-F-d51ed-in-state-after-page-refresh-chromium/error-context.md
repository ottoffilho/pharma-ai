...
- Name: Authentication Flow E2E >> should remember login state after page refresh
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:84:3
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:87:16
```
