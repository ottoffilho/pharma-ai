...
- Name: Authentication Flow E2E >> should redirect to login when accessing admin without authentication
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:14:3
...
Received string:  "https://pharmaai.com.br/admin"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    8 × locator resolved to <html lang="pt-BR">…</html>
      - unexpected value "https://pharmaai.com.br/admin"

    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:16:24
```
