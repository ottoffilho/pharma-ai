...
- Name: Authentication Flow E2E >> should load the login page correctly
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:19:3
...
Locator: locator('h3')
Expected string: "Fazer Login"
Received string: "Erro 404"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h3')
    8 × locator resolved to <h3>Erro 404</h3>
      - unexpected value "Erro 404"

    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:23:38
```
