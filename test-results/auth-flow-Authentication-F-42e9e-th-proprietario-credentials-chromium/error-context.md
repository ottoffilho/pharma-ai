...
- Name: Authentication Flow E2E >> should login successfully with proprietario credentials
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:65:3
...
Call log:
  - waiting for locator('input[placeholder="seu@email.com"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:69:16
```
