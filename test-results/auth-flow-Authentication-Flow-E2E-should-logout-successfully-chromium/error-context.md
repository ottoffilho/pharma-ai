...
- Name: Authentication Flow E2E >> should logout successfully
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:105:3
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:108:16
```
