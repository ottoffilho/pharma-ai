...
- Name: Authentication Flow E2E >> should show login form correctly
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:26:3
...
Locator: locator('input[placeholder="seu@email.com"]')
Expected: visible
...
Call log:
  ...
  - waiting for locator('input[placeholder="seu@email.com"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:30:70
```
