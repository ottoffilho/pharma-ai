...
- Name: Authentication Flow E2E >> should validate user information display after login
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:244:3
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:247:16
```
