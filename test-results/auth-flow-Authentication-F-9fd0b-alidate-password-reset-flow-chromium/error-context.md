...
- Name: Authentication Flow E2E >> should validate password reset flow
- Location: D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:212:3
...
Call log:
  ...
  - waiting for locator('input[type="email"]')
    ...
    at D:\PROJETOS\pharma.ai\tests\e2e\auth-flow.spec.ts:219:55
```
