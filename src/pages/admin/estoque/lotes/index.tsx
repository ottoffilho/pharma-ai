            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
              ...
              <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Vencimento Próximo</p>
                      <p className="text-2xl font-bold text-yellow-600">{lotesVencimentoProximo?.length || 0}</p>
                    </div>
              ...
              <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Lotes Vencidos</p>
                      <p className="text-2xl font-bold text-red-600">{lotesVencidos?.length || 0}</p>
                    </div>
                    ...
                    <TableBody>
                      {filteredLotes.length === 0 ? (
                        ...
                        filteredLotes.map((lote) => {
                          ...
                          return (
                            <TableRow key={lote.id} className="hover:bg-orange-50/50">
                              ...
                              <TableCell>
                                <div className="flex flex-col">
                                  <span className="font-medium">{lote.quantidade_atual}</span>
                                  <span className="text-sm text-muted-foreground">
                                    de {lote.quantidade_inicial} {(lote as LoteExtended & { produtos?: { unidade_medida?: string } }).produtos?.unidade_medida || 'UN'}
                                  </span>
                                </div>
                              </TableCell>
                              <TableCell>
